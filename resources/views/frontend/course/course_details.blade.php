                    ...
                    <div class="course-details-overview p-t-50 p-t-lg-5">
                                                            ...
                                                            <a href="#"
                                                                ...
                                                                <div class="title">
                                                                    <div
                                                                        ...
                                                                        @if($lesson->is_free == 1 || ( auth()->user()?->role_id == 2 && in_array(auth()->id(), $lesson->course->instructor_ids) ))
                                                                        <svg width="20px"
                                                                            height="20px"
                                                                            viewBox="0 0 24 24"
                                                                            fill="none"
                        ...
                        <div class="comments-template comments-template-v2">
                            ...
                            <div class="comments-respond"
                                ...
                                <form action="{{ route('store.comment') }}"
                                    method="post">
                                    @csrf
                                        ...
                                        <p class="course-countdown m-b-15">
                                            <svg width="16"
                                                ...
                                                <path
                                                    ...
                                                    stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M8 3.80078V8.00078L10.8 9.40078"
                                                    stroke="#FF4747"
                                                    stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                            </svg>
...
<input type="hidden"
    class="text_copied"
    value="{{ __('text_copied') }}">
<input type="hidden"
    class="text_copied_fail"
    value="{{ __('text_copied_fail') }}">
...
@push('css')
<link rel="stylesheet"
    href="{{ static_asset('frontend/css/star-rating-svg.css') }}">
@endpush
@push('js')
