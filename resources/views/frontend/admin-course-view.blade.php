            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    @elseif(@$selected_lesson->lesson_type === 'doc')
                        @if (str_ends_with($file, 'pdf'))
                            ...
                            <object id="meetingIframe"
                                    ...
                                    width="100%"
                                    height="700">
                                <iframe src="{{ $file }}" width="100%" height="600">
                    ...
                    <div>
                        ...
                        <br>
                        @if(strtolower($selected_lesson->lesson_type) === 'live_session')
                            ...
                            @elseif($selected_lesson->live_date !== null && $selected_lesson->date?->isFuture())
                                <span class="btn btn-info"
                                      style="margin-left: 10px"> Upcoming in </span>
                            @endif
                        @endif

                        {{$selected_lesson->live_date}}
                    </div>
                                                                                ...
                                                                                @if ($section->lessons->count() > 0)
                                                                                    @foreach ($section->lessons as $k => $lesson)
                                                                                        <li class="change_video">
                                                                                            @php
                                                                                                $routeName = (auth()->user()->user_type === 'student') ? 'lesson.details' : 'admin.lesson.details';
                                                                                            @endphp
                                                                                                    ...
                                                                                                    <table class="table align-middle"
                                                                                                        ...
                                                                                                        @if( count($lesson->assignments) > 0 )
                                                                                                            ...
                                                                                                            @foreach($lesson->assignments as $assignment)
                                                                                                                @include('frontend.profile.lesson_assignment_load_more')
                                                                                                            @endforeach
                                                                                                        @endif
                                                                                                    </table>
