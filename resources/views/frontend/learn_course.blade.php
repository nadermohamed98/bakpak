...
@section('content')
    <style>
        ...
        table.assignment-table th, table.assignment-table td {
            padding: 4px 8px !important; /* Adjust padding for a smaller look */
        }

        table.assignment-table th {
            text-align: center; /* Optional: Center-align headers */
        }
    </style>
    <!--====== Start Course Video Section ======-->
    <section class="course-video-section p-t-50 p-b-100 p-t-sm-30">
        <div class="container container-1278 container-pdf-js-viewer">
            <div class="row">
                <div class="col-lg-8">
                    <div class="row">
                        <div class="col-12">
                    ...
                    @if (@$selected_lesson->lesson_type == 'video')
                        @if($selected_lesson->source == 'mp4' || $selected_lesson->source == 'upload')
                            <div class="video-lesson-player video-wrapper lesson-playlist"
                                 id="player">
                                <video onplay="onPlay(this)"
                                       ontimeupdate="timeUpdate(this)"
                                       onpause="onPause(this)"
                                       onended="onEnded(this)"
                        ...
                        @elseif($selected_lesson->source == 'youtube')
                            <div class="video-lesson-player video-wrapper lesson-playlist video_block"
                                 ...
                                 id="player"
                                 data-progress="{{ $lesson_progress ? $lesson_progress->total_spent_time : 0 }}">
                                <iframe src="https://www.youtube.com/embed/{{ $selected_lesson->source_data }}?origin=https://plyr.io&amp;iv_load_policy=3&amp;modestbranding=1&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;enablejsapi=1"
                                        allowfullscreen
                                        allowtransparency
                                        allow="autoplay"
                                        @if ($selected_lesson->images) data-poster="{{ getFileLink('295x248', $selected_lesson->images) }}"
                        ...
                        @elseif($selected_lesson->source == 'vimeo')
                            <div class="video-lesson-player video-wrapper lesson-playlist video_block"
                                 ...
                                 id="player"
                                 data-progress="{{ $lesson_progress ? $lesson_progress->total_spent_time : 0 }}">
                                <iframe src="https://player.vimeo.com/video/{{ $selected_lesson->source_data }}?loop=false&amp;byline=false&amp;portrait=false&amp;title=false&amp;speed=true&amp;transparent=0&amp;gesture=media"
                                        allowfullscreen
                                        allowtransparency
                                        allow="autoplay"
                                        @if ($selected_lesson->images) data-poster="{{ getFileLink('295x248', $selected_lesson->images) }}"
                    ...
                    @elseif(@$selected_lesson->lesson_type == 'audio')
                        <div class="audio-wrapper audio_block"
                             id="audio_payer"
                             data-progress="{{ $lesson_progress ? $lesson_progress->total_spent_time : 0 }}">
                    ...
                    @elseif(@$selected_lesson->lesson_type === 'doc')
                        ...
                        @if (str_ends_with($file, 'pdf'))
                            <a href="#" onclick="toggleFullScreen()">Go Full Screen</a>
                            <div style="background-color: #f0f0f0; padding: 10px;">
                                <object id="meetingIframe"
                                        data="{{ $file }}"
                                        type="application/pdf"
                                        width="100%"
                                        height="700">
                                    <embed src="{{ $file }}" type="application/pdf" width="100%" height="600">
                    ...
                    <div>
                        {{strip_tags($selected_lesson?->description)}}
                        @if(@$selected_lesson->lesson_type == 'live_session')
                            @if(@$selected_lesson->live_date != null && @$selected_lesson->date?->isToday())
                                <a href="{{@$selected_lesson->session_url }}"
                                   target="_blank"
                            ...
                            @elseif(@$selected_lesson->live_date != null && @$selected_lesson->date?->isPast())
                                <span class="btn btn-secondary"
                                      style="margin-left: 10px"> Ended </span>
                            @elseif(@$selected_lesson->live_date != null && @$selected_lesson->date?->isFuture())
                                <span class="btn btn-info"
                                      style="margin-left: 10px"> Upcoming </span>
                            @endif
                        @endif
                    </div>
                ...
                <div class="col-lg-4 m-t-md-45">
                    <div class="sidebar-container">
                        ...
                        <div class="education-level-tab-content tab-content"
                             id="education-level-tabContent">
                            <div class="tab-pane fade show active"
                                ...
                                <div class="education-group-tabs">
                                    <ul class="nav nav-tabs mb-4"
                                        ...
                                        @if($live_class != null && $live_class->meeting_link != null)
                                            <li class="nav-item" role="presentation">
                                                <a href="{{ $live_class->meeting_link }}" 
                                                target="_blank" 
                                                class="btn btn-success">{{ auth()->user()->user_type == 'student' ? 'Join Meeting' : 'Start Meeting' }}</a>
                                            </li>
                                         @endif
                                    ...
                                    <div class="education-group-tab-content tab-content"
                                         id="myTabContent">
                                        <div class="tab-pane fade show active"
                                             id="curriculum"
                                             role="tabpanel"
                                                            ...
                                                            <div class="accordion-item">
                                                                <div class="accordion-header"
                                                                    ...
                                                                    <div class="accordion-button {{ isset($selected_lesson) && $selected_lesson->section_id == $section->id ? '' : 'collapsed' }}"
                                                                         ...
                                                                         {{ isset($selected_lesson) && $selected_lesson->section_id == $section->id ? 'aria-expanded="true"' : 'aria-expanded="false"' }} aria-controls="course-curriculum-collapse{{ $key }}">
                                                                        {{ $section->title }}
                                                                    </div>
                                                                </div>
                                                                                ...
                                                                                @if ($section->lessons->count() > 0)
                                                                                    @foreach ($section->lessons as $k => $lesson)
                                                                                        <li class="change_video">
                                                                                            ...
                                                                                            @php
                                                                                                $routeName = (auth()->user()->user_type == 'student') ? 'lesson.details' : 'instructor.lesson.details';
                                                                                            @endphp

                                                                                            <a href="{{ route($routeName, ['course' => $course->slug, 'slug' => $lesson->slug]) }}">
                                                                                                <div class="icon">
                                                                                                    ...
                                                                                                    @elseif($lesson->lesson_type == 'audio')
                                                                                                        <svg width="12"
                                                                                                            ...
                                                                                                            <path d="M11.2667 6.72754V8.00027C11.2667 9.18169 10.7258 10.3147 9.76315 11.1501C8.80046 11.9855 7.49478 12.4548 6.13333 12.4548C4.77189 12.4548 3.46621 11.9855 2.50352 11.1501C1.54083 10.3147 1 9.18169 1 8.00027V6.72754"
                                                                                                                  stroke="#FDCC0D"
                                                                                                                  stroke-width="1.2"
                                                                                                                  stroke-linecap="round"
                                                                                                                  stroke-linejoin="round"/>
                                                                                                            <path d="M6.13281 12.4541V14.9996"
                                                                                                                  stroke="#FDCC0D"
                                                                                                                  stroke-width="1.2"
                                                                                                                  stroke-linecap="round"
                                                                                                                  stroke-linejoin="round"/>
                                                                                                            <path d="M3.20312 15H9.06979"
                                                                                                                  stroke="#FDCC0D"
                                                                                                                  stroke-width="1.2"
                                                                                                                  stroke-linecap="round"
                                                                                                                  stroke-linejoin="round"/>
                                                                                                    ...
                                                                                                    @elseif($lesson->lesson_type == 'live_session')
                                                                                                        <svg width="13"
                                                                                                             height="14"
                                                                                                             viewBox="0 0 24 24"
                                                                                                             fill="none"
                                                                                                ...
                                                                                                <span class="{{ $lesson->slug == request()->route()->parameter('slug') ? 'active_lesson' : '' }}">{{ $lesson->title }}</span>
                                                                                            </a>
                                                                                            @if(isset($lesson->assignments) && $lesson->assignments->isNotEmpty())
                                                                                                <br>
                                                                                                <hr>
                                                                                                <h4 class="table-info">
                                                                                                    Lesson
                                                                                                ...
                                                                                                <div class="icon">
                                                                                                    <svg width="16"
                                                                                                        ...
                                                                                                        <path d="M8 15C11.866 15 15 11.866 15 8C15 4.13401 11.866 1 8 1C4.13401 1 1 4.13401 1 8C1 11.866 4.13401 15 8 15Z"
                                                                                                              ...
                                                                                                              stroke-linecap="round"
                                                                                                              stroke-linejoin="round"/>
                                                                                                        <path d="M5.96094 5.89923C6.12551 5.43139 6.45034 5.0369 6.87791 4.78562C7.30547 4.53434 7.80816 4.44248 8.29696 4.52633C8.78576 4.61017 9.22911 4.86429 9.54849 5.2437C9.86787 5.6231 10.0427 6.10329 10.0419 6.59923C10.0419 7.99923 7.94194 8.69923 7.94194 8.69923"
                                                                                                              stroke="#D16D86"
                                                                                                              stroke-width="1.4"
                                                                                                              stroke-linecap="round"
                                                                                                              stroke-linejoin="round"/>
                                                                                                        <path d="M8 11.5H8.007"
                                                                                                              stroke="#D16D86"
                                                                                                              stroke-width="1.4"
                                                                                                              stroke-linecap="round"
                                                                                                              stroke-linejoin="round"/>
                                                        ...
                                                        @foreach ($my_resource as $key => $resource)
                                                            <div class="accordion-item">
                                                                ...
                                                                <div id="resource-curriculum-collapse{{ $key }}"
                                                                     ...
                                                                     data-bs-parent="curriculumAccordion">
                                                                    <div class="accordion-body">
                                                                        <div class="bg-white redious-border p-20 rounded-10">
                                                                            <div class="resources-content d-flex align-items-start align-items-sm-center flex-column flex-sm-row gap-20">
                                                                                <div class="resources-icon redious-border redious-border-5 p-20 mr-1">
                                                                                    <svg width="40"
                                                                                         height="40"
                                                                                         viewBox="0 0 40 40"
                                                                                         fill="none"
...
@push('js')
    ...
    <script src="{{ static_asset('frontend/js/pdf.js') }}"></script>
    <script>
			$(document).ready(function () {
				console.log('PDF loaded 111');
				var url = '{{ $file }}';
				var pdfjsLib = window[static_asset('frontend/js/pdf')];
				pdfjsLib.GlobalWorkerOptions.workerSrc = static_asset('frontend/js/pdf.worker.js');
