                            ...
                            <div class="row gx-20 add-coupon">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-4">
                                        ...
                                        <div class="select-type-v2">
                                            <select id="organization " class="form-control form-select-lg mb-3 with_search organization_balance" name="organization" data-url="<?php echo e(route('ajax.organizations-balanceCheck')); ?>">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-4">
                                        ...
                                        <div class="select-type-v2">
                                            <select id="paymentMethod " class="form-control form-select-lg mb-3 with_search" name="payment_method">
