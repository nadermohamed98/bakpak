                            ...
                            <div class="row gx-20 add-coupon">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        ...
                                        <select id="department" name="department_id" class="form-control form-select-lg mb-3 without_search">
                                ...
                                <div class="col-lg-6">
                                    <div class="select-type-v2 mb-4">
                                        ...
                                        <select id="priority" name="priority" class="form-control form-select-lg mb-3 without_search">
                                ...
                                <div class="col-lg-6">
                                    <div class="select-type-v2 mb-4">
                                        ...
                                        <select id="status" name="status" class="form-control form-select-lg mb-3 without_search">
