        ...
        <nav class="side-nav">
            <ul>
                ...
                @if(hasPermission('courses.index') || hasPermission('category.index') || hasPermission('subjects.index') || hasPermission('tag.index') || hasPermission('level.index') || hasPermission('certificates.index'))
                    <li class="{{ menuActivation(['admin/category/*', 'admin/category', 'admin/subjects/*', 'admin/subjects', 'admin/tags/*', 'admin/tag', 'admin/level/*', 'admin/level', 'admin/courses/*', 'admin/courses', 'admin/quizzes', 'admin/certificates*', 'admin/grading-schemes', 'admin/grading-schemes/*', 'admin/assignment-groups', 'admin/assignment-groups/*'], 'active') }}">
                        <a href="#course"
                           class="dropdown-icon"
                           data-bs-toggle="collapse"
                           role="button"
                           aria-expanded="{{ menuActivation(['admin/category/*', 'admin/category', 'admin/subjects/*', 'admin/subjects', 'admin/tag/*', 'admin/tag', 'admin/level/*', 'admin/level', 'admin/courses/*', 'admin/courses', 'admin/quizzes', 'admin/certificates*', 'admin/grading-schemes', 'admin/grading-schemes/*', 'admin/assignment-groups', 'admin/assignment-groups/*'], 'true', 'false') }}"
                           aria-controls="course">
                            <i class="las la-book"></i>
                            <span>{{ __('course') }}</span>
                        </a>
                        <ul class="sub-menu collapse {{ menuActivation(['admin/category/*', 'admin/category', 'admin/subjects/*', 'admin/subjects', 'admin/tag/*', 'admin/tag', 'admin/level/*', 'admin/level', 'admin/courses/*', 'admin/courses', 'admin/quizzes', 'admin/certificates*', 'admin/grading-schemes', 'admin/grading-schemes/*', 'admin/assignment-groups', 'admin/assignment-groups/*'], 'show') }}"
                            id="course">
                            ...
                            @if(hasPermission('courses.index'))
                                <li>
                                    <a class="{{ menuActivation(['admin/grading-schemes', 'admin/grading-schemes/*'], 'active') }}"
                                       href="{{ route('admin.grading-schemes.index') }}">{{ __('grading_schemes') }}</a>
                                </li>
                            @endif
                            @if(hasPermission('courses.index'))
                                <li>
                                    <a class="{{ menuActivation(['admin/assignment-groups', 'admin/assignment-groups/*'], 'active') }}"
                                       href="{{ route('admin.assignment-groups.index') }}">{{ __('assignment_groups') }}</a>
                                </li>
                            @endif
                        </ul>
                    </li>
                @endif
                @if(hasPermission('book_shelf.index') || hasPermission('book_shelf.create'))
                    <li class="{{ menuActivation(['admin/book_shelf', 'admin/book_shelf/*', 'admin/book_shelf/create', 'admin/quizzes/editBookShelf/*'], 'active') }}">
                        <a href="#manageBookShelf"
                           class="dropdown-icon"
                           data-bs-toggle="collapse"
                           role="button"
                           aria-expanded="{{ menuActivation(['admin/book_shelf', 'admin/book_shelf/*', 'admin/book_shelf/create', 'admin/quizzes/editBookShelf/*'], 'true', 'false') }}"
                           aria-controls="manageBookShelf">
                            <i class="las la-user-tie"></i>
                            <span>{{ __('book_shelf') }}</span>
                        </a>
                        <ul class="sub-menu collapse {{ menuActivation(['admin/book_shelf', 'admin/book_shelf/*', 'admin/book_shelf/create', 'admin/quizzes/editBookShelf/*'], 'show') }}"
                            id="manageBookShelf">

                            @if(hasPermission('book_shelf.index'))
                                <li>
                                    <a class="{{ menuActivation(['admin/book_shelf'], 'active') }}"
                                       href="{{ route('book_shelf.index') }}">{{ __('book_shelf_list') }}</a>
                                </li>
                            @endif


                            @if(hasPermission('book_shelf.create'))
                                <li><a class="{{ menuActivation('admin/book_shelf/create', 'active') }}"
                                       href="{{ route('book_shelf.create') }}">{{ __('add_book_shelf') }}</a></li>
                            @endif
                        </ul>
                    </li>
                @endif
                ...
                @if(hasPermission('payouts.method-setting') || hasPermission('payouts.create') || hasPermission('payouts.index'))
                    ...
                    <li class="{{ menuActivation(array('admin/payouts*'), 'active') }}">
                        ...
                        <ul class="sub-menu collapse {{ menuActivation(['admin/payouts*'], 'show') }}"
                            id="payout">
                            ...
                            @if(hasPermission('student-faqs.index'))
                                <li>
                                    <a class="{{ menuActivation(['admin/student-faqs', 'admin/student-faqs/*'], 'active') }}"
                                       href="{{ route('student-faqs.index') }}">{{ __('faq') }}</a>
                                </li>
                            @endif
                            ...
                            @if(hasPermission('departments.index'))
                                <li>
                                    <a class="{{ menuActivation(['admin/departments', 'admin/departments/*'], 'active') }}"
                                       href="{{ route('departments.index') }}">{{ __('department') }}</a>
                                </li>
                            @endif
                        </ul>
                    </li>
                            ...
                            @if(hasPermission('header.logo'))
                                <li>
                                    <a class="{{ menuActivation(['admin/header-logo', 'admin/header-topbar', 'admin/header-menu'], 'active') }}"
                                       href="{{ route('header.logo') }}">{{ __('header_content') }}</a>
                                </li>
                            @endif
                            ...
                            @if(hasPermission('offline-methods.index'))
                                <li>
                                    <a class="{{ menuActivation(['admin/offline-methods', 'admin/offline-methods*'], 'active') }}"
                                       href="{{ route('offline-methods.index') }}">{{ __('payment_methods') }}</a>
                                </li>
                            @endif
                        </ul>
                    </li>
                ...
                hasPermission('ai_writer.setting') || hasPermission('countries.index') || hasPermission('states.index') || hasPermission('cities.index') || hasPermission('admin.refund'))
                    ...
                    <li class="{{ menuActivation(['admin/currencies','admin/countries','admin/states','admin/cities', 'admin/ai-writer-setting', 'admin/languages','admin/language/*', 'admin/system-setting', 'admin/cache','admin/preference', 'admin/storage-setting', 'admin/panel-setting', 'admin/miscellaneous-setting', 'admin/refund-setting'], 'active') }}">
                        ...
                        <ul class="sub-menu collapse {{ menuActivation(['admin/currencies','admin/countries','admin/states','admin/cities', 'admin/ai-writer-setting', 'admin/languages','admin/language/*', 'admin/system-setting', 'admin/cache', 'admin/preference', 'admin/storage-setting', 'admin/panel-setting', 'admin/miscellaneous-setting', 'admin/refund-setting'], 'show') }}"
                            ...
                            href="{{ route('admin.refund') }}">{{ __('refund_setting') }}</a>
                    </li>
                    @endif --}}
