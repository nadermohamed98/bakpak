                ...
                <div class="row gx-20">
                    ...
                    <div class="col-6">
                        <div class="mb-4">
                            ...
                            <input type="date" name="live_date" class="form-control rounded-2" id="videoLessonDate"
                    ...
                    <div class="col-6">
                        <div class="mb-4">
                            ...
                            <input type="time" name="live_from" class="form-control rounded-2" id="videoLessonFrom"
                    ...
                    <div class="col-6">
                        <div class="mb-4">
                            ...
                            <input type="time" name="live_to" class="form-control rounded-2" id="videoLessonTo"
