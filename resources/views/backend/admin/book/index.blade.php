                        ...
                        <div class="row gx-20 mb-30">
                            <div class="col">
                                <div class="select-type-v2">
                                    ...
                                    <select id="categories" class="form-control form-select-lg mb-3 without_search" aria-label=".form-select-lg example">
                            ...
                            <div class="col">
                                <div class="select-type-v2">
                                    ...
                                    <select id="bookType" class="form-control form-select-lg mb-3 without_search" aria-label=".form-select-lg example">
                                        <option selected>All</option>
                            ...
                            <div class="col">
                                <div class="select-type-v2">
                                    ...
                                    <select id="bookPublisher" class="form-control form-select-lg mb-3 without_search" aria-label=".form-select-lg example">
                                        <option selected>All</option>
                            ...
                            <div class="col">
                                <div class="select-type-v2">
                                    ...
                                    <select id="bookAuthor" class="form-control form-select-lg mb-3 without_search" aria-label=".form-select-lg example">
                                        <option selected>All</option>
