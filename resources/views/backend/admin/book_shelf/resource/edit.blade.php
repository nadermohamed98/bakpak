<form action="{{ route('resources.update',$resource->id) }}" method="post" class="form" enctype="multipart/form-data">@csrf
    @method('PUT') 
    ...
    <div class="row gx-20">
        <div class="col-6">
            <div class="mb-4">
                ...
                <input type="text" name="title" class="form-control rounded-2" placeholder="{{ __('enter_title') }}" value="{{ $resource->title }}">
        ...
        <div class="col-6">
            <div class="mb-4">
                <div class="mb-20">
                    ...
                    <input id="datePicker" type="text" name="deadline" value="{{ \Carbon\Carbon::parse($resource->deadline)->format('m/d/Y') }}" class="datePickerUP form-control rounded-2">
                </div>
                <div class="nk-block-des text-danger">
