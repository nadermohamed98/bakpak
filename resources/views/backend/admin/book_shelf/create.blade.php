...
@section('title', __('add_book_shelf'))
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="section-title">{{ __('add_book_shelf') }}</h3>
                @php
                    $step_1_error = false;
                    $step_2_error = false;
                    $step_3_error = false;
                    // 'instructor_ids', 'duration'
                    $step_1_errors = ['title', 'category_id', 'subject_id', 'organization_id', 'language_id', 'level_id'];
                    ...
                    <ul class="nav justify-content-center pb-40 mb-0" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link {{ $step_2_error || $step_3_error ? '' : 'active' }} {{ $step_1_error ? 'text-danger' : '' }}"
                                id="basicInformation" data-bs-toggle="pill" data-bs-target="#basicBookShelfInformation"
                                role="tab" aria-controls="basicBookShelfInformation" aria-selected="true">
                                <span
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link {{ $step_2_error ? 'active text-danger' : '' }}" id="mediaImages"
                                data-bs-toggle="pill" data-bs-target="#bookShelfMediaImages" role="tab"
                                aria-controls="bookShelfMediaImages" aria-selected="false">
                                <span
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link {{ $step_3_error && !$step_2_error ? 'active text-danger' : '' }}"
                                id="pricing" data-bs-toggle="pill" data-bs-target="#bookShelfPricing" role="tab"
                                aria-controls="bookShelfPricing" aria-selected="false">
                                <span
                                    class="default-tab-count {{ $step_3_error && !$step_2_error ? 'bg-danger text-white' : '' }}">{{ __('3') }}</span>{{ __('pricing') }}</a>
                        </li>
                        @endif
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="seo" data-bs-toggle="pill" data-bs-target="#bookShelfSEO"
                                role="tab" aria-controls="bookShelfSEO" aria-selected="false">
                                <span class="default-tab-count">{{ __('3') }}</span>{{ __('seo') }}</a>
                        </li>
                    </ul>
                    <!-- End Add New Course tab menu -->

                    <form action="{{ route('book_shelf.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="tab-content" id="mgCourse-tabContent">
                            <div class="tab-pane fade {{ $step_2_error || $step_3_error ? '' : 'show active' }}"
                                id="basicBookShelfInformation" role="tabpanel" aria-labelledby="basicInformation"
                                tabindex="0">
                                <div class="row gx-20">
                                    <div class="col-lg-6">
                                        <div class="mb-4">
                                            <label for="bookShelfTitle" class="form-label">{{ __('book_shelf_title') }}</label>
                                            <input type="text" value="{{ old('title') }}"
                                                class="form-control rounded-2 ai_content_name" id="bookShelfTitle"
                                                name="title" placeholder="{{ __('book_shelf_title') }}">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-4">
                                            <div class="select-type-v2">
                                                <label for="bookShelfType" class="form-label">{{ __('book_shelf_type') }}</label>
                                                <select id="bookShelfType" name="book_shelf_type"
                                                   class="form-control form-select-lg mb-3 without_search"
                                                    aria-label=".form-select-lg">
                                                    <option value="book_shelf"
                                                        {{ old('book_shelf_type') == 'book_shelf' ? 'selected' : '' }}>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-4">
                                            <div class="select-type-v2">
                                                <label for="bookShelfLevel"
                                                    class="form-label">{{ __('book_shelf_level') }}</label>
                                                <select id="bookShelfLevel"
                                                   class="form-control form-select-lg mb-3 with_search" name="level_id"
                                                    aria-label=".form-select-lg">
...
{{--                                    <div class="col-lg-6">--}}
{{--                                        <div class="mb-4">--}}
{{--                                            <label for="bookShelfDuration"--}}
{{--                                                class="form-label">{{ __('book_shelf_duration') }}</label>--}}
{{--                                            <input type="text" class="form-control rounded-2" id="bookShelfDuration"--}}
...
{{--                                    </div>--}}
                                    ...
                                    <div class="col-lg-6">
                                        <div class="multi-select-v2 mb-4">
                                            <label for="tag" class="form-label">{{ __('book_shelf_tag') }}</label>
                                        ...
                                        <div class="mb-4">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                @include('backend.common.ai_btn', [
                                                    ...
                                                    'use_case' => 'short description for book shelf',
                                                ])
                                            </div>
                                        ...
                                        <div class="editor-wrapper">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                @include('backend.common.ai_btn', [
                                                    ...
                                                    'length' => '259',
                                                    'topic' => 'ai_content_name',
                                                    'use_case' => 'long description for book shelf',
                                                    'long_description' => 1,
                                                ])
                                            </div>
                            ...
                            <div class="tab-pane fade {{ $step_2_error ? 'show active' : '' }}" id="bookShelfMediaImages"
                            ...
                            <div class="tab-pane fade" id="bookShelfSEO" role="tabpanel" aria-labelledby="seo"
                                tabindex="0">
                                <div class="row gx-20">
