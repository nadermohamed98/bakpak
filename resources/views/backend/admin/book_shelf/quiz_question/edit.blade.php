    ...
    <div class="row gx-20">
        ...
        <div class="col-12">
            <div class="mb-4">
                ...
                <div class="select-type-v2">
                    <select id="question_type" name="question_type" class="form-control form-select-lg mb-3 without_search">
        ...
        <div class="col-12 question_div {{ $question->question_type == 'text_question' ? 'd-none' : '' }} ">
            <div class="">
                ...
                <div class="moveable-lit p-30 default_question_div {{ $question->question_type == 'mcq' ? 'd-none' : '' }} rounded-2 border">
                    <div class="answer_area" id="answerAreaMoved">
                        @foreach($question->answers as $key=> $answer)
                        <div class="input-group mb-20">
                            <input type="text" class="form-control" name="answers[]" placeholder="Answer" value="{{ $answer['answer'] }}">
                            <div class="custom-radio">
                                <label>
                                    <input type="radio" name="correct_answer" value="{{ ++$key }}" {{ $answer['is_correct'] == 1 ? 'checked' : 0 }}>
                                    <span class=""></span>
                                </label>
...
{{--                            <span class="input-group-text"><i class="las la-trash-alt ml-3"></i></span>--}}
                ...
                <div class="moveable-lit p-30 mcq_div {{ $question->question_type == 'mcq' ? '' : 'd-none' }} rounded-2 border">
                    <div class="answer_area">
                        @foreach($question->answers as $key=> $answer)
                        <div class="input-group mb-20">
                            <input type="hidden" name="mcq_correct_answer[]" class="mcq_correct_answer" value="{{ $answer['is_correct'] }}">
                            <input type="text" class="form-control" name="mcq_answers[]" placeholder="Answer" value="{{ $answer['answer'] }}">
    ...
    <div class="d-flex justify-content-between align-items-center mt-30">
        <button type="button" class="btn sg-btn-outline-primary" data-bs-dismiss="modal" aria-label="Close">Cancel
        </button>
