...
@section('content')
                    ...
                    <div class="bg-white redious-border p-20 p-sm-30">
                        <form action="{{ route('quizzes.update', $quiz->id) }}" class="form" method="POST">@csrf
                            ...
                            <div class="row">
                                ...
                                <input type="hidden" name="section_id" class="section_id" value="{{ $quiz->section_id }}">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-4">
                                        ...
                                        <textarea class="summernote" name="instructions" placeholder="{{ __('Enter instructions') }}">{{ $quiz->instructions }}</textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex gap-12 sandbox_mode_div">
                                        ...
                                        <div class="setting-check">
                                            <input type="checkbox" value="1" id="certificate_included"
                                                class="sandbox_mode"
                                                {{ $quiz->certificate_included == 1 ? 'checked' : '' }}>
                                ...
                                <div class="d-flex gap-12 sandbox_mode_div mb-4">
                                    ...
                                    <div class="setting-check">
                                        <input type="checkbox" value="1" id="status" class="sandbox_mode"
                                            {{ $quiz->status == 0 ? '' : 'checked' }}>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    @foreach ($questions as $question)
                                        <div class="list-view py-12 ps-2 pe-3 pe-sm-30 mb-20">
                                            ...
                                            <ul class="d-flex align-items-center gap-20">
                                                <li><a href="#" class="icon edit_modal"
                                                        data-total_answers="{{ count($question->answers) }}"
                                                        data-fetch_url="{{ route('quiz-questions.editBookShelf', $question->id) }}"
                                                        data-route="{{ route('quiz-questions.update', $question->id) }}"
                                                        data-modal="editQuiz"><i class="lar la-edit"></i></a></li>
                                                <li><a class="icon" data-bs-placement="top" href="javascript:void(0)"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-30">
                                        <a href="{{ route('book_shelf.edit', $book_shelf->id) }}?tab=curriculum"
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('quiz-questions.store') }}" method="POST" class="form">@csrf
                    <div class="row gx-20">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="select-type-v2">
                                    <select id="question_type" name="question_type"
                                        ...
                                        <option value="default" selected>Multiple Choice
                                        </option>
                                        <option value="mcq">Multiple Answer</option>
                        ...
                        <div class="col-12">
                            <div class="mb-4">
                                ...
                                <textarea class="summernote form-control rounded-2" name="question" id="question" placeholder="Enter Question"></textarea>
                                <div class="nk-block-des text-danger">
                                ...
                                <div class="moveable-lit p-20 p-sm-30 default_question_div rounded-2 border">
                                    <div class="answer_area" id="answerAreaMoved">
                                        <div class="input-group mb-20">
                                            <input type="text" class="form-control correct-answer-radio"
                                                name="answers[]" placeholder="Answer">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-30">
                        ...
                        <button type="submit" class="btn sg-btn-primary">Add Question
                        </button>
    ...
    <div class="modal checkbox_modal">
        <div class="input-group mb-20">
            <input type="hidden" name="mcq_correct_answer[]" class="mcq_correct_answer">
            <input type="text" class="form-control" name="mcq_answers[]" placeholder="Answer">
            <div class="custom-checkbox">
                <label>
                    <input type="checkbox">
                    <span class="ms-12"></span>
...
@push('js')
    {{-- Quiz answers js --}}
    <script src="{{ static_asset('admin/js/custom/quiz-answer.js') }}"></script>
@endpush
