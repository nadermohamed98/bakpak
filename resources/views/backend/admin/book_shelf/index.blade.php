...
@section('title', __('book_shelf_list'))
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="header-top d-flex justify-content-between align-items-center">
                    <h3 class="section-title">{{__('book_shelf_list') }}</h3>
                    @if(request()->routeIs('book_shelf.index'))
                    ...
                    @if(request()->routeIs('book_shelf.index'))
                        <div class="col-lg-12" id="filterSection">
                            <div class="hidden-filter bg-white redious-border p-20 p-sm-30 mb-4">
                                <form action="{{ route('book_shelf.index') }}" method="GET">
