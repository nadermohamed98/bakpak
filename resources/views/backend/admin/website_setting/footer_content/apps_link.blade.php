                            ...
                            <div class="row gx-20">
                                <div class="col-12">
                                    ...
                                    <div class="select-type-v2 mb-40">
                                        <select class="form-control form-select-lg mb-3 with_search selectric lang" name="site_lang">
                            ...
                            <div class="row gx-20">
                                ...
                                <div class="col-12">
                                    <div class="mb-4">
                                        ...
                                        <textarea class="summernote" id="description" name="apps_link_description" placeholder="{{ __('enter_description') }}">{{ setting('apps_link_description',$lang) }}</textarea>
                                        <div class="nk-block-des text-danger">
