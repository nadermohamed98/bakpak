                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="multi-select-v2">
                                                        ...
                                                        <select multipleclass="form-control rounded-0 mb-3"
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="multi-select-v2">
                                                        <select name="builder[featured_course_{{$i}}][ids][]"
                                                                data-is_featured="1"
                                                                placeholder="{{ __('select_course') }}"
                                                               class="form-control form-select-lg mb-3" multiple>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="multi-select-v2">
                                    <select name="builder[instructors]" multiple
                                            placeholder="{{ __('select_instructor') }}"
                                           class="form-control form-select-lg mb-3"></select>
                                </div>
                            </div>
                            <!-- End Instructor -->
                        </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="multi-select-v2">
                                    <select name="builder[featured_course]" data-is_featured="1"
                                            placeholder="{{ __('select_course') }}"
                                           class="form-control form-select-lg mb-3" multiple></select>
                                </div>
                            </div>
                            <!-- End Single Course -->
                        </div>
