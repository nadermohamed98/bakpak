                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-12">
                                <div class="select-type-v2 mb-4 ">
                                    ...
                                    <select class="form-control form-select-lg mb-3 with_search" name="header_font" id="header_font">
                            ...
                            <div class="col-xl-6 col-lg-12">
                                <div class="select-type-v2 mb-4 ">
                                    ...
                                    <select class="form-control form-select-lg mb-3 with_search" name="body_font" id="body_font">
                                        <option value="">{{ __('select_fonts') }}</option>
                                        @foreach(google_fonts_list() as $font_name => $font_family)
...
<!--                            <div class="col-lg-6">
                            ...
                            <div class="col mb-4">
                                ...
                                <select class="form-control form-select-lg mb-3 with_search" name="theme_color">
