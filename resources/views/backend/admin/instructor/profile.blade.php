                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="sg-text-primary" target="_blank"
                                                       href="{{ route('organizations.overview', $instructor->organization_id) }}">:{{ $instructor->organization->org_name }}</a>
                                                </td>
                                            </tr>
                    ...
                    <div class="row gx-20">
                        <div class="col-12">
                            <div class="select-type-v2 mb-4">
                                ...
                                <select id="selectCourse" class="form-control form-select-lg mb-3 without_search"
                        ...
                        <div class="col-12">
                            <div class="select-type-v2 mb-4">
                                ...
                                <select id="meetingMethod" class="form-control form-select-lg mb-3 without_search"
                                        aria-label=".form-select-lg example">
