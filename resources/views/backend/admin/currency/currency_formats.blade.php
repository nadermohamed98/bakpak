          ...
          @csrf
            <div class="col-12">
              <div class="mb-4">
                ...
                <div class="select-type-v2">
                  <select class="form-control form-select-lg without_search mb-3" name="currency_symbol_format">
            ...
            <div class="col-12">
              <div class="mb-4">
                ...
                <div class="select-type-v2">
                  <select class="form-control form-select-lg without_search mb-3" name="decimal_separator">
            ...
            <div class="col-12">
              <div class="mb-4">
                ...
                <div class="select-type-v2 mb-3 mb-sm-30">
                  <select class="form-control form-select-lg without_search mb-3" name="no_of_decimals">
