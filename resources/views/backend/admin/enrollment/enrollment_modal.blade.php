<div class="modal fade" id="student_modal" tabindex="-1" aria-labelledby="editCityLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('bulk.enrollments') }}"
                  method="POST"
                  class="form">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-4">
                            <label for="country"
                                   class="form-label">{{__('student') }} <span
                                        class="text-danger">*</span></label>
                            <div class="select-type-v2">
                                <select class="form-control form-select-lg mb-3"
                                        data-role_id="3"
                                        data-route="{{ route('ajax.users') }}"
                                        name="student_id[]"
                                        id="student"
                                        multiple
                                        placeholder="{{ __('select_students') }}">
                                </select>
                    ...
                    <div class="col-12">
                        <div class="mb-4">
                            <label for="state"
                                   class="form-label">{{__('course') }} <span
                                        class="text-danger">*</span></label>
                            <div class="select-type-v2">
