                ...
                <div class="row gx-20">
                    ...
                    <div class="col-6">
                        <div class="mb-4">
                            ...
                            <div class="select-type-v2">
                                <select class="form-control form-select-lg mb-3 without_search lesson_source"
                                    name="source">
                    ...
                    <div class="col-lg-12">
                        <div class="mb-4">
                            ...
                            <textarea class="summernote" name="description" placeholder="{{ __('enter_description') }}"></textarea>
                        </div>
                    </div>
...
<div class="modal fade" id="live_session" tabindex="-1" aria-labelledby="lessonLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <h6 class="sub-title">{{ __('Add Live Session') }}</h6>
            <button type="button" class="btn-close modal-close" data-bs-dismiss="modal"
                aria-label="Close"></button>
            ...
            <form action="{{ route('lessons.store') }}" method="post" class="form"
                enctype="multipart/form-data">@csrf
                <div class="row gx-20">
                    <input type="hidden" name="lesson_type" value="live_session">
                    <input type="hidden" name="course_id" value="{{ $course->id }}">
                    <input type="hidden" name="section_id" class="section_id">
                    <input type="hidden" class="is_modal" value="0">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        <div class="mb-4">
                            ...
                            <input type="date" name="live_date" class="form-control rounded-2"
                                id="videoLessonTitle" placeholder="{{ __('enter date') }}">
                            <div class="nk-block-des text-danger">
                                <p class="title_error error"></p>
                            </div>
                        </div>
                    ...
                    <div class="col-6">
                        <div class="mb-4">
                            ...
                            <input type="time" name="live_from" class="form-control rounded-2"
                                id="videoLessonTitle" placeholder="{{ __('enter from') }}">
                            <div class="nk-block-des text-danger">
                                <p class="title_error error"></p>
                            </div>
                        </div>
                    ...
                    <div class="col-6">
                        <div class="mb-4">
                            ...
                            <input type="time" name="live_to" class="form-control rounded-2"
                                id="videoLessonTitle" placeholder="{{ __('enter to') }}">
                            <div class="nk-block-des text-danger">
                                <p class="title_error error"></p>
                            </div>
                        </div>
...
<div class="modal fade" id="edit_live_session_lesson" tabindex="-1" aria-labelledby="lessonLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <h6 class="sub-title">{{ __('Edit Live Session') }}</h6>
            <button type="button" class="btn-close modal-close" data-bs-dismiss="modal"
                aria-label="Close"></button>
            <div class="form_div">
            </div>
                ...
                <div class="row gx-20">
                    ...
                    <div class="col-lg-12">
                        <div class="mb-4">
                            ...
                            <textarea class="summernote" name="instructions" placeholder="{{ __('Enter instructions') }}">{{ isset($quiz) ? $quiz->instructions : '' }}</textarea>
                        </div>
                    </div>
