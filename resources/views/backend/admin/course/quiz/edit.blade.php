                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-30">
                                        <a href="{{ route('courses.edit', $course->id) }}?tab=curriculum"
                    ...
                    <div class="row gx-20">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="select-type-v2">
                                    <select id="question_type" name="question_type"
                                        ...
                                        <option value="default" selected>Multiple Choice</option>
                        ...
                        <div class="col-12">
                            <div class="mb-4">
                                ...
                                <textarea class="summernote" name="question" class="form-control rounded-2" id="question"
