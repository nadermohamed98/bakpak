    ...
    <div class="row gx-20">
        <div class="col-lg-12">
            <div class="mb-4">
                ...
                <div class="select-type-v2">
                    <select id="packageName" name="name" class="form-control form-select-lg mb-3 without_search">
        ...
        <div class="col-lg-6">
            <div class="mb-4">
                ...
                <div class="select-type-v2">
                    <select id="packageValidity" name="validity" class="form-control form-select-lg mb-3 without_search">
        ...
        <div class="col-lg-6">
            <div class="mb-4">
                ...
                <div class="select-type-v2">
                    <select id="courseBundle" class="form-control form-select-lg mb-3 without_search" name="bundle">
        ...
        <div class="col-lg-6">
            <div class="mb-4">
                ...
                <div class="select-type-v2">
                    <select id="liveClassFacilities" class="form-control form-select-lg mb-3 without_search" name="facilities">
        ...
        <div class="col-lg-12">
            <div class="">
                ...
                <div class="select-type-v2">
                    <select id="packageStatus" class="form-control form-select-lg mb-3 without_search" name="status">
