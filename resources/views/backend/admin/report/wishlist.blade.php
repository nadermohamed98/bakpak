                        ...
                        <div class="row gx-20">
                            <div class="col">
                                <div class="select-type-v2">
                                    ...
                                    <select id="category" class="form-control form-select-lg mb-3 with_search" aria-label=".form-select-lg example" name="category_id">
                            ...
                            <div class="col">
                                <div class="select-type-v2">
                                    ...
                                    <select id="organisation" class="form-control form-select-lg mb-3 with_search" aria-label=".form-select-lg example" name="organization_id">
                                        <option value="" selected>{{__('all')}}</option>
