                    ...
                    <div class="selection-row gx-20">
                        <div class="col-custom">
                            <div class="select-type-v2">
                                ...
                                <select id="course" class="form-control form-select-lg mb-3 without_search"
                        ...
                        <div class="col-custom">
                            <div class="select-type-v2">
                                ...
                                <select id="categories" class="form-control form-select-lg mb-3 without_search"
                                        aria-label=".form-select-lg example">
                                    <option selected>{{__('all')}}</option>
                                    <option value="1">Marketing</option>
                                    <option value="2">Design</option>
                        ...
                        <div class="col-custom">
                            <div class="select-type-v2">
                                ...
                                <select id="organisation" class="form-control form-select-lg mb-3 without_search"
                                        aria-label=".form-select-lg example">
                                    <option selected>{{__('all')}}</option>
                        ...
                        <div class="col-custom">
                            <div class="select-type-v2">
                                ...
                                <select id="ReportDataRange" class="form-control form-select-lg mb-3 without_search"
                                        aria-label=".form-select-lg example">
                                    <option selected>{{__('all')}}</option>
                            ...
                            <div class="oftions-content-left">
                                <form action="#" class="">
                                    <div class="select-type-v2 d-flex align-items-center gap-20">
                                        ...
                                        <select name="dataRange" id="dataRange" class="form-control without_search"
                                                aria-label=".form-select-lg example">
