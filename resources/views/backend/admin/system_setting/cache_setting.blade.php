                        ...
                        <div class="row gx-20">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    ...
                                    <select class="form-control form-select-lg mb-3 without_search" name="is_cache_enabled" id="cache_status">
                            ...
                            <div class="col-lg-12 default_cache_div {{ setting('is_cache_enabled') == 'enable' ? '' : 'd-none' }}">
                                <div class="mb-4">
                                    ...
                                    <div class="select-type-v2">
                                        <select class="form-control form-select-lg mb-3 without_search" name="default_cache" id="default_cache">
                                            <option value="file"
