                        ...
                        <div class="lang-select">
                            <form id="lang">
                                ...
                                <div class="select-type-v2 mb-40">
                                    <select class="form-control form-select-lg mb-3 with_search lang" name="site_lang">
                        ...
                        <div class="row gx-20">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <select class="form-control form-select-lg mb-3 with_search" name="time_zone"
                                        id="time_zone">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <div class="select-type-v2">
                                        <select class="form-control form-select-lg mb-3 with_search" name="default_country"
                                            id="country">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <div class="select-type-v2">
                                        <select class="form-control form-select-lg mb-3 with_search"
