...
class CourseDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            })->setRowId('id')->setRowId('id') ->addColumn('instructor', function ($course) {
                $instructorIds = $course->instructor_ids ?? [];
                //  \Log::info('Instructor IDs:', ['ids' => $instructorIds]);
    ...
    public function query(): QueryBuilder
    {
        ...
        return Course::with('category.language')->withCount('enrolls')->when($id, function ($query) use ($id) {
            ...
            $query->whereIn('course_type', $course_type);
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('instructor')->title(__('instructor'))->searchable(false),
