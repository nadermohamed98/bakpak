...
class QuizQuestionController extends Controller
{
	...
	public function store(Request $request): JsonResponse
	{
		$request->validate([
			'question' => [
				'required', Rule::unique('quiz_questions')->where(function ($query) use ($request) {
	...
	public function edit($id): View|Factory|JsonResponse|Application
	{
		try {
	...
	public function editBookShelf($id): View|Factory|JsonResponse|Application
	{
		try {
			$question = $this->quizQuestion->find($id);
			...
			$response_data = [
				'status' => 'success',
				'html' => view('backend.admin.book_shelf.quiz_question.edit', $data)->render(),
			];
	...
	public function update(Request $request, $id): JsonResponse
	{
		$request->validate([
			'question' => [
				'required', Rule::unique('quiz_questions')->where(function ($query) use ($request, $id) {
