...
class AssignmentController extends Controller
{
	...
	public function store(Request $request): JsonResponse
	{
		$request->validate([
			'title' => [
				'required', Rule::unique('assignments')->where(function ($query) use ($request) {
	...
	public function editBookShelf($id): JsonResponse
    {
        try {
            $user       = new UserRepository();
            $assignment = $this->assignment->find($id);
            ...
            $data       = [
                'html' => view('backend.admin.book_shelf.assignment.edit', $data)->render(),
            ];
