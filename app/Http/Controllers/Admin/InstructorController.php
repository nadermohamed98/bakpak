...
class InstructorController extends Controller
{
	...
	public function create(Request $request,
		ExpertiseRepository $expertiseRepository): View|Factory|RedirectResponse|Application
    {
        try {
            $data = [
	...
	public function edit(ExpertiseRepository $expertiseRepository, $id): View|Factory|RedirectResponse|Application
    {
        try {
            $user = $this->user->find($id);
            $data = [
