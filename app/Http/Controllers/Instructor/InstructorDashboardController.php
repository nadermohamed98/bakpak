...
class InstructorDashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = [
            ...
            'total_student_count'   => User::where('user_type', 'student')->whereHas('checkout.enrolls', function ($query) use ($coursesIds) {
            ...
            'total_enrolment_count'  => Enroll::whereIn('enrollable_id',$coursesIds)->count(),
